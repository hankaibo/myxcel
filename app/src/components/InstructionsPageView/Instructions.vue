<template>
  <div class="content">
    ...
    <!-- 1 -->
    <h3>关于XCel</h3>
    <p>myxcel -《Excel数据过滤工具》是九次方前端出品的一款通过可视化操作对Excel文档（.xls和.xlsx）进行过滤筛选的工具。</p>
    ...
    <h3>联系</h3>
    <p>如遇软件使用上的问题，请联系
      <a @click="openExternal('aotu')">九次方前端</a>。同时，也欢迎你提出宝贵的意见。</p>
    <p>问题提交地址：
    ...
    <p>咚咚：刘健超</p>
    <div>
      <img src="./assets/qrcode.jpg" alt="九次方前端二维码">
    </div>
  </div>
</template>
